...
static const int showbar                   = 0; /* 0 means no bar (hidden by default) */
...
/* tagging */
static char *tags[] = { "Eins", "Zwei", "Drei", "Vier" };
...
/* Use `make <machine>` to build with machine-specific monitor config from monitors/<machine>.h */
/* MONITORS_PLACEHOLDER */
...
/* Workspace keys use META (Super/Windows key) */
